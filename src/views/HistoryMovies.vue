<template>
  <div class="homex-div">
    <div class="homex">
      ...
      <h1 class="h-one">History Movies</h1>
      <div class="movi-div">
...
export default {
  ...
  setup() {
    ...
    const Movix1 = () => {
      fetch(
        ...
        .then((data) => {
          history1.value = data.results.filter(
            (p) => p.genre_ids.indexOf(36) !== -1
          );
        });
    };
    const Movix2 = () => {
      fetch(
        ...
        .then((response) => response.json())
        .then((data) => {
          history2.value = data.results.filter(
            (p) => p.genre_ids.indexOf(36) !== -1
          );
        });
    };
    const Movix3 = () => {
      fetch(
        ...
        .then((response) => response.json())
        .then((data) => {
          history3.value = data.results.filter(
            (p) => p.genre_ids.indexOf(36) !== -1
          );
        });
    };
    const Movix4 = () => {
      fetch(
        ...
        .then((response) => response.json())
        .then((data) => {
          history4.value = data.results.filter(
            (p) => p.genre_ids.indexOf(36) !== -1
          );
        });
    };
    const Movix5 = () => {
      fetch(
        ...
        .then((response) => response.json())
        .then((data) => {
          history5.value = data.results.filter(
            (p) => p.genre_ids.indexOf(36) !== -1
          );
        });
    };
    const Movix6 = () => {
      fetch(
        ...
        .then((response) => response.json())
        .then((data) => {
          history6.value = data.results.filter(
            (p) => p.genre_ids.indexOf(36) !== -1
          );
        });
    };
    const Movix7 = () => {
      fetch(
        ...
        .then((response) => response.json())
        .then((data) => {
          history7.value = data.results.filter(
            (p) => p.genre_ids.indexOf(36) !== -1
          );
        });
    };
    const Movix8 = () => {
      fetch(
        ...
        .then((response) => response.json())
        .then((data) => {
          history8.value = data.results.filter(
            (p) => p.genre_ids.indexOf(36) !== -1
          );
        });
    };
    const Movix9 = () => {
      fetch(
        ...
        .then((response) => response.json())
        .then((data) => {
          history9.value = data.results.filter(
            (p) => p.genre_ids.indexOf(36) !== -1
          );
        });
    };
    const Movix10 = () => {
      fetch(
        ...
        .then((response) => response.json())
        .then((data) => {
          history10.value = data.results.filter(
            (p) => p.genre_ids.indexOf(36) !== -1
          );
        });
    };
    const Movix11 = () => {
      fetch(
        ...
        .then((response) => response.json())
        .then((data) => {
          history11.value = data.results.filter(
            (p) => p.genre_ids.indexOf(36) !== -1
          );
        });
    };
    const Movix12 = () => {
      fetch(
        ...
        .then((response) => response.json())
        .then((data) => {
          history12.value = data.results.filter(
            (p) => p.genre_ids.indexOf(36) !== -1
          );
        });
    };
  ...
  computed: {
    sum() {
      let allActions = [];
      allActions = this.history1
        .concat(this.history2)
        .concat(this.history3)
        .concat(this.history4)
        .concat(this.history5)
        .concat(this.history6)
        .concat(this.history7)
        .concat(this.history8)
        .concat(this.history9)
        .concat(this.history10)
        .concat(this.history11)
        .concat(this.history12);
      if (this.search !== "") {
